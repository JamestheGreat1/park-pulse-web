...
- Fixed desktop ride sheets so they stay vertically centered, use the available viewport height, and no longer inherit the mobile swipe transform or hang off the bottom.
