import { PARKS, parkName, minutesLabel, relativeTime, escapeHtml, isRideStale } from "./data.js?v=1.9.0-preview.2";
import { store } from "./store.js?v=1.9.0-preview.2";
import { rideData, fetchRideHistory, fetchRideInsights, fetchAnalyticsStatus } from "./api.js?v=1.9.0-preview.2";
import { currentSubscription, enablePush, syncRules, disablePush, backendHealth, sendTestPush } from "./push.js?v=1.9.0-preview.2";
import { applySeasonalTheme, seasonalEffectsEnabled, setSeasonalEffectsEnabled, glassStyleSetting, setGlassStyleSetting } from "./seasonal.js?v=1.9.0-preview.2";
...
const APP_VERSION = "1.9.0-preview.2";
...
function bindRideCards(root = views.explore) {
  ...
  $('[data-quick-actions]', root).forEach((button) => {
